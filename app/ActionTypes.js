...
export const SAVE_SELECTED_EXERCISE = 'SAVE_SELECTED_EXERCISE';
export const DISMISS_SELECT_EXERCISE = 'DISMISS_SELECT_EXERCISE';
export const CHANGE_SLIDER_VELOCITY = 'CHANGE_SLIDER_VELOCITY';
export const CHANGE_SLIDER_DAYS = 'CHANGE_SLIDER_DAYS';
