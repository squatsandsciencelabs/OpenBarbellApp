import { DISMISS_HISTORY_EXERCISE } from 'app/configs+constants/ActionTypes';
...
export const cancelExercise = () => (dispatch, getState) => {
    var state = getState();
...
export const saveExerciseName = (exercise) => (dispatch, getState) => {
    var state = getState();
