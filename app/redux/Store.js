...
export default initializeStore = () => {
    ...
    const fsPersistor = persistStore(store, {
        ...
        transforms: [
            ...
            createFilter('settings', ['defaultMetric', 'endSetTimerDuration', 'syncDate', 'wasTimerEdited', 'wasMetricEdited', 'lastExportCSVDate', 'velocityThresholdEnabled', 'velocityThreshold']),
