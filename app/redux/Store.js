...
export default initializeStore = () => {
    ...
    const fsPersistor = persistStore(store, {
        ...
        transforms: [
            ...
            createFilter('analysis', ['exercise', 'velocitySlider', 'daysRange', 'tagsToInclude', 'tagsToExclude', 'exercise', 'velocity', 'e1RM', 'tagsToInclude', 'tagsToExclude', 'daysRange', 'velocity', 'e1RM' ]),
